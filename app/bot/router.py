...
from app.bot.handlers import admin, feedback, full_scan, mini_scan, payment, session, start
...
main_router.include_router(feedback.router)  # LAST — catch-all for free text & reviews
