...
async def generate_and_deliver_report(
    ...
    # Финальное сообщение — что делать дальше
    await bot.send_message(
        chat_id,
        "✅ <b>Разбор готов. Что дальше?</b>\n\n"
        "Три пути:\n\n"
        "1️⃣ <b>Осознать и действовать самостоятельно</b>\n"
        "Перечитай разбор. Выпиши, что откликнулось. Один шаг — сегодня.\n\n"
        "2️⃣ <b>Пойти к терапевту</b>\n"
        "Если разбор показал глубокие программы — их нужно прорабатывать телесно. "
        "Покажи терапевту блок «Глубина — родовое и скрытое».\n\n"
        "3️⃣ <b>Задать вопрос боту</b>\n"
        "Если что-то непонятно в разборе — просто напиши вопрос прямо сюда в чат. "
        "Я уточню.\n\n"
        "━━━━━━━━━━━━━━━━\n"
        "Если нужна живая работа — Юлия отвечает лично:",
        parse_mode="HTML",
